        ...
        <div className="creators-header mb-16 md:mb-32 flex flex-col md:flex-row md:items-end justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="text-6xl md:text-[8rem] font-playfair font-black text-slate-900 leading-[0.8] tracking-tighter uppercase">
              CREATIVE <br />
              <span className="italic font-light text-slate-300">FORCE.</span>
            </h2>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="p-12 relative">
        ...
        <div className="text-xs text-slate-400 font-mono tracking-wider mb-8 uppercase font-bold">{char.role}</div>
        
        <p className="font-light text-slate-500 text-base leading-relaxed uppercase tracking-widest">
          {char.desc}
        </p>
